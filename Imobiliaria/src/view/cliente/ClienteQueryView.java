...
public class ClienteQueryView extends javax.swing.JDialog {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(jRBCpf.isSelected()){           
            this.clienteTableModel = new ClienteTableModel(this.clienteController.findCpf(jTFPesquisa.getText()));  
            jTable1.setModel(this.clienteTableModel);  
        }else if(jRBNome.isSelected()){
            this.clienteTableModel = new ClienteTableModel(this.clienteController.findNome(jTFPesquisa.getText()));  
            jTable1.setModel(this.clienteTableModel);  
        }else {
